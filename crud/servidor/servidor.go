...
// Funcao para busca de usuarios no banco de dados
...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	db, erro := banco.Conectar()
	if erro != nil {
		w.Write([]byte("Erro ao conectar com o bancvo de dados"))
		return
	}
	...
	if linha.Next() {
		if erro := linha.Scan(&usuario.ID, &usuario.Nome, &usuario.Email); erro != nil {
			w.Write([]byte("Erro ao scanear dados do usuario"))
			return
		}
	}
	w.WriteHeader(http.StatusOK)
...
// Atualizar Usuario alterar os dados do usuario no banco de dados
